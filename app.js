...
var incompleteTaskHolder=document.querySelector(".to-do__list");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".completed-tasks__box");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="item__input input-text";
